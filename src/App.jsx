...
const App = () => {
    ...
    const homeFAQs = [
        {
            question: t("wimawdtcd"),
            answer: t(
                "wahmisocitdsasutlidtlaiiotbraot"
            ),
        },
        {
            question: t("hdmseds"),
                    ...
                    <>
                        ...
                        <div className="rounded-b-[12px] w-full flex justify-between items-center border-b border-[#EBECED] px-[1rem] py-[0.5rem]">
                            <div className="flex items-center gap-x-[10px]">
                                <a
                                    href="https://www.margsoft.com/contact-us"
                                    target="_blank"
                        ...
                        >
                            ...
                            >
                                <a
                                    href="https://www.margsoft.com/about-margsoft"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                ...
                                <a
                                    href="https://www.margsoft.com/Services"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="text-black cursor-pointer whitespace-nowrap text-center border border-[#D1D5DB] bg-[#F3F4F6] hover:bg-[#E5E7EB] text-[13px] font-medium rounded-[15px] py-[0.3rem] px-[0.8rem]"
                                >
                                ...
                                <a
                                    href="https://www.margsoft.com/sitemap"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="text-black cursor-pointer whitespace-nowrap text-center border border-[#D1D5DB] bg-[#F3F4F6] hover:bg-[#E5E7EB] text-[13px] font-medium rounded-[15px] py-[0.3rem] px-[0.8rem]"
                                >
                                ...
                                <a
                                    href="https://www.margsoft.com/careers"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="text-black cursor-pointer whitespace-nowrap text-center border border-[#D1D5DB] bg-[#F3F4F6] hover:bg-[#E5E7EB] text-[13px] font-medium rounded-[15px] py-[0.3rem] px-[0.8rem]"
                                >
